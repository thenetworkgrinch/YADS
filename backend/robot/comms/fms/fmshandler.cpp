...
{
    Logger::instance().log(Logger::Info, "FMSHandler", "Initializing robot comms FMS handler");
    ...
    Logger::instance().log(Logger::Info, "FMSHandler", "Robot comms FMS handler initialized");
}

FMSHandler::~FMSHandler()
{
    Logger::instance().log(Logger::Info, "FMSHandler", "Shutting down robot comms FMS handler");
    ...
    Logger::instance().log(Logger::Info, "FMSHandler", "Robot comms FMS handler shutdown complete");
}
