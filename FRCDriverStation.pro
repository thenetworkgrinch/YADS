...
TARGET = FRCDriverStation
TEMPLATE = app

# Version information
VERSION = 2025.1.0
QMAKE_TARGET_COMPANY = "FRC Driver Station"
QMAKE_TARGET_PRODUCT = "FRC Driver Station"
QMAKE_TARGET_DESCRIPTION = "FRC Driver Station Application"
...
contains(DEFINES, ENABLE_FMS_SUPPORT=1) {
    SOURCES += backend/robot/comms/fms/fmshandler.cpp
    HEADERS += backend/robot/comms/fms/fmshandler.h
}
